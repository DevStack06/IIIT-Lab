clc %It clear command window
clear % It uses for clearing workspace
close all %Close all previous paragraph
...
for i=1:a/2 %This loop divide sequence into an even part and odd part
...
exp = 2.718281828; % Below code is uses for finding DFT of Even part
